...
/// ordinary way. And null for a lesson room that somebody else has since been
/// invited into, because by then the sentence would not be true.
///
...
String? teacherToSendTo({
  ...
  // The promise is about who is in the room, not about the link that made it.
  // A lesson link builds a room with two people in it (0129) and nothing
  // holds it there: the teacher owns the room and can invite anybody — an
  // accompanist, a second student — and share_layer (0057) tells every
  // member. So the moment there is a third person this goes back to being a
  // room being told, and says so, rather than promising one listener and
  // delivering three.
