      ...
      builder: (dialogContext) => AlertDialog(
        ...
        content: const SingleChildScrollView(
          child: Text(
            ...
            'you sent.\n\n'
            // Calls shipped on 16 September 2026 and this page did not say a
            // word about them (audit, the next day).
            'Calls\n\n'
            'A call between people in a room runs through LiveKit, which carries '
            'the sound and the picture while the call is on. Calls are never '
            'recorded. While you are in one the app notes that you are there, so '
